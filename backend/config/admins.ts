/**
 * Admin identity lives in the environment, not the database, so there is no
 * bootstrap problem — the first admin exists the moment the server starts,
 * with no "who creates the creator" step. Admins are a handful of operators
 * and change rarely; the lists they *manage* are what live in the DB.
 *
