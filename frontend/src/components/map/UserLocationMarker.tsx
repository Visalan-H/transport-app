    ...
    <Marker longitude={location.lng} latitude={location.lat}>
        <div className="flex flex-col items-center gap-1">
            ...
            <div className="relative size-10">
                <span className="absolute inset-0 m-auto size-full animate-ping rounded-full bg-blue-400 opacity-40" />
                <div className="absolute inset-0 m-auto size-3 rounded-full bg-blue-500 shadow-lg shadow-blue-500/80" />
            </div>
        </div>
    </Marker>
);
